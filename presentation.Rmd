...
osc_2015_science <- figs("osc_2015_science")
munafo_etal_2017 <- figs("munafo_etal_2017_nature")
```
...
osc_2015_science("fig3", draw = TRUE)
```
...
```{r}
munafo_etal_2017("fig1", draw = TRUE)
```
...
```{r, fig.cap="Excel panic. Well, did you make changes or didn't you??"}
